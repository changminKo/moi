...
| `deploy finished: <sha>` | Sent only after readiness 200, both markets NORMAL, placement enabled and every running runtime container at the checked-out revision were observed. | Nothing. |
